...
## ============================================================
## Process KIRC tumor and normal files
## ============================================================

kirc_tumor <- process_cptac_file(
  expr_file = "CCRCC_RNAseq_gene_RSEM_coding_UQ_1500_log2_Tumor.txt",
  class_name = "kirc"
)

kirc_normal <- process_cptac_file(
  expr_file = "CCRCC_RNAseq_gene_RSEM_coding_UQ_1500_log2_Normal.txt",
  class_name = "normal"
)
...
common_genes <- intersect(
  colnames(kirc_tumor),
  colnames(kirc_normal)
)

common_genes <- setdiff(common_genes, "Class")

kirc_tumor_common <- kirc_tumor[, c(common_genes, "Class")]
kirc_normal_common <- kirc_normal[, c(common_genes, "Class")]
...
cat("\nFinal KIRC + Normal dimensions:\n")
print(dim(kirc_final))

cat("\nFinal class distribution:\n")
print(table(kirc_final$Class))
